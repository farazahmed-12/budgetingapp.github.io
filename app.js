...
// if we have to show the income we can just simply type the amount and description or we can type amount with "+" but if we have to show expense we have to mustt type '-' before the amount we type
